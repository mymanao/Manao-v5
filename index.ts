...
registry.registerAll([
  balance, gamble, autobet, give, set,
  version, help, uptime,
  love, hate, stomp, eat,
  nickname, language, currency, link,
  songPlaying, songQueue, songSkip, songRemove, songRequest, songDefault,
  announce, shoutout, game, stream, event,
]);
